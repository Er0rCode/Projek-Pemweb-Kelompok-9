  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 text-center">
        <img src="foto/coba3.jpg" class="img-fluid rounded" alt="Rumah Impian">
      </div>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 mb-4 mb-md-0 text-center">
        <img src="foto/coba4.jpg" class="img-fluid rounded shadow" alt="Tentang Kami" style="max-width: 400px;">
      </div>
